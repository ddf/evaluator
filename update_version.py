...
def main():
  ...
  plistpath = scriptpath + "/resources/Evaluator-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Evaluator-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Evaluator-OSXAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  for line in fileinput.input(scriptpath + "/installer/Evaluator.iss",inplace=1):
